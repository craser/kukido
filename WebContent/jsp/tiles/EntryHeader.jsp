...
<!-- EntryHeader Tile -->
<h2 class="title" style="border: 0; border-top: 1px dotted #ccc; margin-top: 0.5em;"><dmg:entrylink entry="entry"><span style="color: #aaa"><bean:write name="entry" property="datePosted" format="MM/dd/yy" /></span> <bean:write name="entry" property="title" /></dmg:entrylink></h2>
