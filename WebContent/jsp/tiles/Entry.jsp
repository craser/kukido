        ...
        <logic:present name="entry" property="imageFileName">
          <logic:equal name="entry" property="imageFileType" value="image">
            <p style="text-align: center">
	          <a class="titleimage" data-lightbox="<%= entry.getEntryId() %>" href="attachments/posters/<%= entry.getImageFileName() %>"><img class="titleimage" alt="<%= entry.getTitle() %>" src="attachments/postcards/<%= entry.getImageFileName() %>"></a>
            </p>
          </logic:equal>
