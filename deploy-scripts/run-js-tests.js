(function main() {
    try {
        ...
        var jQuery = workDir + "/jquery-1.11.3.js";
        ...
        files.forEach(function(file) {
            ...
            failed += runTests(fs, jQuery, oneBanana, workJs, testJs);
        });
        phantom.exit(failed);
    }
    catch (e) {
...
function runTests(fs, jQuery, oneBanana, workJs, testJs) {
    eval(fs.read(jQuery));        // (Re)initialize jQuery framework.
